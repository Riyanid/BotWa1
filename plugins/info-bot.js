...
seconds: 18,
fileLength: 18,
 ptt: true, contextInfo: { forwardingScore: 999, isForwarded: false, externalAdReply: {title: 'RubotX - MultiDevice', body: wm, sourceUrl: 'https://chat.whatsapp.com/ERJYROUy4roJXCxZ6zJrHB', thumbnail: await (await fetch(thumb)).buffer(),}}  
  }) 
}
