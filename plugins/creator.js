...
let bjir = 'https://telegra.ph/file/3e93ee245276496deb324.jpg'
let pp = await conn.profilePictureUrl(who).catch(_ => hwaifu.getRandom())
let name = await conn.getName(who)

let delay = time => new Promise(res => setTimeout(res, time))

  await conn.reply(m.chat, 'Owner RubotX - MultiDevice', fpayment)
...
seconds: 22,
fileLength: 22,
 ptt: true, contextInfo: { forwardingScore: 999, isForwarded: false, externalAdReply: {title: 'ᴍʏ ᴄʀᴇᴀᴛᴏʀ RubotX', body: wm, sourceUrl: 'https://wa.me/6283181666350?text=hai+bang', thumbnail: await (await fetch(bjir)).buffer(),}} 
 })
